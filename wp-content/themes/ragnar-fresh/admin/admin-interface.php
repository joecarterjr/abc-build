    ...
    <div id="main">
      ...
      <div id="content"> <?php echo $ragnar_options_machine->Inputs /* Settings */ ?> 
		<div class="group" id="import"><h2><?php esc_attr_e('Import', 'ragnar') ?></h2>
				...
				<h4><?php esc_attr_e('Which demo you wish to import?', 'ragnar') ?></h4>
				<span style="color:#E74C3C">
				<?php
				include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
				if(!is_plugin_active( 'revslider/revslider.php')){		
					esc_attr_e('Note: Revolution Slider plugin is not activated! Revolution sliders demo content will not be imported!','ragnar');} ?>
				</span>
				<p><input type="radio" name="import_demo" value="default" checked><?php esc_attr_e('Default Theme -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo1">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo2" ><?php esc_attr_e('Demo version 2 -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo2">Check demo</a></p>			
				<p><input type="radio" name="import_demo" value="demo3" ><?php esc_attr_e('Demo version 3 -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo3">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo4" ><?php esc_attr_e('Demo version 4 -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo4">Check demo</a></p>				
				<p><input type="radio" name="import_demo" value="demo5" ><?php esc_attr_e('Demo version 5 -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo5">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo6" ><?php esc_attr_e('Demo version 6 -> ', 'ragnar') ?><a target = "_blank" href="http://ragnar.premiumcoding.com/demo6">Check demo</a></p>
...
public static function ragnar_optionsframework_machine($options) {
  ...
  if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'start'){   
		...
		$absolute_path = get_template_directory() . '/admin/import/revslider/';
		...
		$slider_array = array(
			'Ragnar-random-posts-manly.zip',
			'ragnar-random-posts.zip',
			'ragnar-grid-posts.zip'
		);
		if(is_plugin_active( 'revslider/revslider.php')){		
		...
		} else if($_GET['import_demo'] == 'demo2')  {
			$file_widget = PMC_PATH . '/import/widget_2.json';
			import(get_template_directory() . '/admin/import/options_2.json');				
